...
@section('content')
    <section class="content-header">
        <h1>Biodata <small>Peserta</small>
        </h1>
        <ol class="breadcrumb">
        ...
        <div class="row">
            <div class="col-md-8">
                <div class="box box-default">
                    <form method="post" action="{{ action('Mahasiswa\BiodataController@store') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        <div class="box-body">
                            ...
                            @if (session('alert-success'))
                                <div class="alert alert-success alert-dismissible">
                                    ...
                                    <h4><i class="icon fa fa-check"></i> File biodata berhasil diupload!</h4>
                                    Anda masih bisa memperbarui file selama dalam masa periode upload.
                                </div>
                            @endif
                            @if ($isJadwalAvailable)
                                <div class="form-group">
                                    <label for="fileBiodata">Biodata</label>
                                    <input type="file" id="fileBiodata" name="fileBiodata">
