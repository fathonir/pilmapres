            ...
            <tbody>
                ...
                <tr>
                    <td style="padding-bottom: 0px; text-align: center;">
                        <h1 style="text-align: center;margin-top: 30px;font-family: sans-serif;color: #444;padding-bottom: 0px;">Welcome to the site, Test Mail</h1>
                        <p style="padding: 5px;color: #A4A4A4;font-family: sans-serif;font-size: 14px;width: 80%;text-align: center;margin:  0 auto;">Your registered email-id is , Please click on the below link to verify your email account</p>
                    </td>
                </tr>
                <tr>
                    <td style="padding-bottom: 50px;">
                        <div style="margin-top:20px; text-align: center;">
                            <a style="background-color: #2d2994; padding: 10px 50px; border-radius: 3px; border: none;  font-size: 20px; font-family: sans-serif;" href="#" style="color: #F1F1F1;text-decoration: none;font-size: 16px;font-weight: 600;"> Verify Email 
                            </a>
                        </div>
                    </td>
                </tr>
