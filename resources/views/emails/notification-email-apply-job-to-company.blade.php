    ...
    <div style="max-width: 600px; margin: 0px auto; background-color: #fff; box-shadow: 0px 20px 50px rgba(0,0,0,0.05);">
      ...
      <div style="padding: 60px 70px; border-top: 1px solid rgba(0,0,0,0.05);">
        <h1 style="margin-top: 0px;">
          Pencari Kerja Apply Lowongan Anda!
        </h1>
        <div style="color: #636363; font-size: 14px;">
          <p>
            {{ $user->name }}, Selamat lowongan anda telah di apply oleh pencari kerja!
          </p>
          <p>
            Kami akan mencoba menginformasikan lowongan yang anda submit kepada pencarikerja lainnya selama lowongan dalam masa aktif. 
          </p>
          <p>
            Kami berharap anda dapat menemukan pekerja terbaik melalui platform Sindikker. Terimakasih.
          </p>
        </div>
        <div style="border: 2px solid #4B72FA; padding: 40px; margin: 40px 0px;">
          <h4 style="margin-bottom: 20px; margin-top: 0px; font-size: 18px; display: inline-block; border-bottom: 1px dotted #111;">
            Berikut lowongan yang di apply oleh pencari kerja :
          </h4>
          <table style="width: 100%;">
            <tr>
          ...
          <table style="width: 100%; border-top: 1px solid #eee">
            <tr>
              <td style="font-size: 14px;">
                Nama Pelamar: <strong>{{ $user->nama_pelamar }}</strong>
              </td>
