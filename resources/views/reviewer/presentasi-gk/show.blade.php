...
@section('content')
    <section class="content-header">
        <h1>Presentasi Gagasan Kreatif</h1>
        <ol class="breadcrumb">
            <li><a href="#"><i class="fa fa-home"></i> Penilaian Final</a></li>
            <li class="active">Presentasi Gagasan Kreatif</li>
        </ol>
    </section>
                ...
                <div class="box">
                    <div class="box-body">
                        ...
                        @if (session('alert-success'))
                            <div class="alert alert-success alert-dismissible">
                                ...
                                <a href="{{ URL::to('reviewer/presentasi-gk?kegiatan_id='.$peserta->kegiatan_id) }}">Kembali ke Daftar Peserta</a>
                            </div>
                        @endif
                        ...
                        <a href="{{ URL::to('reviewer/presentasi-gk?kegiatan_id='.$peserta->kegiatan_id) }}"
                    ...
                    <div class="box-body">
                        <form method="post" action="{{ URL::current() }}">
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <div class="form-group {{ $errors->first('skor.'.$penilaian->id) ? 'has-error' : '' }}" >
                                                <input type="number" min="5" max="10" step="0.1" class="form-control" name="skor[{{ $penilaian->id }}]" value="{{ old('skor.'.$penilaian->id, $penilaian->skor) }}" data-id="{{ $penilaian->id }}" data-bobot="{{ $penilaian->bobot }}"/>
                                            </div>
                                        </td>
                            ...
                            <div class="form-group">
                                <a href="{{ URL::to('reviewer/presentasi-gk?kegiatan_id='.$peserta->kegiatan_id) }}" class="btn btn-default">Kembali</a>
