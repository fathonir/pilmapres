...
@section('content')
  ...
  <div class="page-header">
    <div class="container">
        <h1 class="title">ANNISA DEWI NUGRAHANI</h1>
    </div>
    <div class="breadcrumb-box">
        <div class="container">
            <ul class="breadcrumb">
                ...
                <li class="active">Detail Finalis</li>
            </ul>
        </div>
    </div>
</div>
            ...
            <div class="sidebar col-sm-12 col-md-3">
                <div class="widget">
                    <div class="widget-title">
                        ...
                        <div class="text-center font-bold-large">ANNISA DEWI NUGRAHANI</div>
                        <div class="text-center">SARJANA - Pendidikan Dokter </div>
                    </div>
                </div>
            </div>
