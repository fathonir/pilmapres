            ...
            <table class="table table-bordered table-condensed table-hover">
              ...
              @foreach ($pesertas as $peserta)
                <tr>
                  ...
                  <td class="text-center"><a href="{{ $peserta->nama_file }}" target="_blank"><i class="fa fa-file-pdf-o text-danger"></i></a></td>
                  <td>{{ strftime('%d/%m/%y %H:%M:%S', strtotime($peserta->created_at)) }}</td>
                  <td>
                    <a class="btn btn-xs btn-info" href="{{ URL::to('admin/peserta/approval?id='.$peserta->id) }}">Proses</a>
                  </td>
                </tr>
              @endforeach
              </tbody>
