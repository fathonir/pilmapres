  ...
  <section class="content">
    <div class="row">
      <div class="col-md-12"></br></br>
        {{ Form::open(array('url' => '/gallery/create', 'files' => true, 'method' => 'post')) }}
            ...
            <!-- form start -->
              <div class="box-body">
                <div class="form-group">
                  ...
                  {{ Form::select('id_category_gallery', $categori_galleri, null,['class' => 'form-control required', 'placeholder' => 'Pilih Category']) }}
                </div>
                <div class="form-group">
