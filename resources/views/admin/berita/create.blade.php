      ...
      <div class="col-md-12">
        {!! Form::open(['action' => 'admin\BeritaController@store', 'files'=>true]) !!}
          ...
          <!-- <div class="form-group">
              <label for=""> Tanggal Berita Upload</label>
              <input type="date" class="form-control" id="datepicker" name="tanggal" placeholder="Tanggal Berita Upload"}}'/>
          </div> -->
          <div class='form-group clearfix'>
            {{ Form::label("tanggal", "Tanggal Berita Upload", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-6'>
              <input type="javascript" name="tanggal" id="datepicker" accept="image/x-png, image/jpeg">
          ...
          <div class='form-group clearfix'>
            {{ Form::label("isi_berita", "Isi Berita", ['class' => 'col-md-2 control-label']) }}
              <div class='col-md-10'>
                {{ Form::textarea("isi_berita", '',['class' => 'form-control required', 'id' => 'isi_berita']) }}
