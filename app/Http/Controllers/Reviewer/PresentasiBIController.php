...
class PresentasiBIController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($request->get('kegiatan_id')) {
            ...
            $pesertas = DB::table('plot_reviewers as pr')
                ...
                ->where('tp.tahapan_id', Tahapan::PRESENTASI_BAHASA_INGGRIS)
        ...
        return view('reviewer.presentasi-bi.index', compact('kegiatans', 'pesertas'));
    }
     ...
     * @return \Illuminate\Http\Response
     */
    public function show(int $plot_reviewer_id)
    {
