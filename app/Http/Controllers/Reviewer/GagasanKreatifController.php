...
class GagasanKreatifController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        if ($request->get('kegiatan_id')) {
            ...
            $pesertas = DB::table('plot_reviewers as pr')
                ...
                ->where('tp.tahapan_id', Tahapan::BABAK_PENYISIHAN_2)
        ...
        return view('reviewer.gagasan_kreatif.index', compact('kegiatans', 'pesertas'));
    }
    ...
    public function show($plot_reviewer_id)
    {
        ...
        $peserta = TahapanPeserta
            ...
            ->where('tahapan_id', Tahapan::BABAK_PENYISIHAN_2)
            ->first()->peserta;
        ...
        $skors = Skor::where('tahapan_id', Tahapan::BABAK_PENYISIHAN_2)->get();

        return view('reviewer.gagasan_kreatif.show', compact(
            'plotReviewer', 'peserta', 'penilaians', 'skors', 'filePesertaPath', 'filePeserta'
        ));
    }
    ...
    public function update(Request $request, $plot_reviewer_id)
    {
        ...
        return redirect(URL::current())->with(['alert-success' => true]);
    }
