...
class PresentasiGKController extends Controller
{
    /**
    ...
    public function index(Request $request)
    {
        ...
        if ($request->get('kegiatan_id')) {
            ...
            $pesertas = DB::table('plot_reviewers as pr')
                ...
                ->where('tp.tahapan_id', Tahapan::PRESENTASI_GAGASAN_KREATIF)
        ...
        return view('reviewer.presentasi-gk.index', compact('kegiatans', 'pesertas'));
    }
    ...
    public function show($plot_reviewer_id)
    {
        ...
        $peserta = TahapanPeserta
            ...
            ->where('tahapan_id', Tahapan::PRESENTASI_GAGASAN_KREATIF)
            ->first()->peserta;
        ...
        return view('reviewer.presentasi-gk.show', compact(
