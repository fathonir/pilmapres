...
class CreatePerguruanTinggisTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('perguruan_tinggis', function (Blueprint $table) {
            ...
            $table->integer('kota_id')->length(10)->unsigned()->nullable();
            $table->string('nama_kota')->length(50)->nullable();
            $table->integer('provinsi_id')->length(10)->unsigned()->nullable();
            ...
            $table->integer('status_milik_id')->length(10)->unsigned()->nullable();
            $table->string('status_milik_nama')->length(100)->nullable();
            $table->char('pembina_id')->length(36)->nullable();
            $table->string('pembina_nama')->length(50)->nullable();
            $table->integer('bentuk_pendidikan_id')->length(10)->unsigned()->nullable();
